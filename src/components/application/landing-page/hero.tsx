    ...
    return (
        <main className="p-5 flex-1 flex flex-col lg:flex-row justify-center items-center relative gap-6">
            ...
            <section className="lg:w-[40%]">
                <section>
                    <p
                        className={`scroll-m-20 text-left text-6xl font-extrabold tracking-tight text-balance ${dancingScript.className}`}
                    >
                        Ship features without fear.
                    </p>
                    <p className="leading-7 [&:not(:first-child)]:mt-4">
                        Feature flags that let you navigate your product
                        releases like a captain — smooth sailing, no surprises
                    </p>
                </section>
